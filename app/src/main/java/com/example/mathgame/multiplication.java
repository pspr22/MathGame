...
public class multiplication extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        life = findViewById(R.id.mlife);
        time = findViewById(R.id.mtime);
        ques = findViewById(R.id.quemul);
        wel = findViewById(R.id.txtmname);
        ans = findViewById(R.id.etansmul);
        ok = findViewById(R.id.okm);
        next = findViewById(R.id.nextm);

        Intent m = getIntent();
        String MYName = m.getStringExtra("name");
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (userLife <= 0) {
                    Intent intentm = new Intent(multiplication.this, finishGame.class);
                    intentm.putExtra("score",userScore);
